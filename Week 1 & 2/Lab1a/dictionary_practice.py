...
'''
# YOUR CODE HERE
print(f"The index of the 4 is {number_dict['cs251'].index(4)}")
...
# YOUR CODE HERE
store_items = {"shoe_store": [], "music_store": []}

for i in range(len(delivery)):
    item = delivery[i]
    if item == "shoes":
        store_items["shoe_store"].append(item)
    else:
        store_items["music_store"].append(item)
    print(f"After adding item {i}:")
    print(f"shoe_store: {store_items['shoe_store']}")
    print(f"music_store: {store_items['music_store']}")
